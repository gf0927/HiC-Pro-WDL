    ...
    scatter (idx in range(length(inputSamples))) {
        ...
        call Making_Plot {
            input:
                ...
                rmMulti = "1",
                rmSingle = "1",
                mappingStatR1 = Merge_Stats.R1_mmapStat,
                mappingStatR2 = Merge_Stats.R2_mmapStat,
                pairStat = Merge_Stats.mPairStat,
                rsStat = Merge_Stats.mRSstat,
...
#        File fakeFile
    ...
    command <<<
        ...
        #這邊之後要改成cat ./*.validPairs | wc -l >> ./output/~{resName}_allValidPairs.mergestat，而非只統計一個
...
task Merge_Stats {
    ...
    output {
        File R1_mmapStat = "./~{sampleName}/~{sampleName}.mmapStatR1"
        File R2_mmapStat = "./~{sampleName}/~{sampleName}.mmapStatR2"
        File mPairStat = "./~{sampleName}/~{sampleName}.mPairStat" 
        File mRSstat = "./~{sampleName}/~{sampleName}.mRSstat"
    }
